...
enum ExperienceLevel: String, Codable, CaseIterable, Identifiable {
    ...
    var title: String {
        ...
        case .someCloud: return "クラウド経験あり"
        }
    }
    var detail: String {
        switch self {
        case .noneAtAll: return "AWS・ITともにほぼ未経験"
        case .someIT:    return "ITの基礎知識はある（非クラウド）"
        case .someCloud: return "AWSや他クラウドを少し触った"
        }
    }
}
...
final class AnswerRecord {
    ...
    var domain: ExamDomain { ExamDomain(rawValue: domainRaw) ?? .cloudConcepts }
}
