...
const LESSONS = [
  ...
  // ===================== billing（請求・料金・サポート）=====================
  {
    ...
    sections: [
      ...
      { heading: "無料利用枠", body: "無料利用枠には、12か月無料・常に無料・トライアルの3種類があります。学習や検証は無料枠を活用しつつ、超過に注意します。※2025年7月以降の新規アカウントは、最大200ドルのクレジット＋Free/Paidプラン方式に変わりました（Freeプランは最長6か月）。ただし『常に無料』の枠は継続し、CLF-C02試験では従来の3種類の考え方も問われます。" },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "ここがポイント", body: "「本番環境で24時間対応が必要→Business以上」「専任担当（TAM）が欲しい→Enterprise」が定番の判断。プラン名と対応レベルの対応関係を押さえます。※実サービスではDeveloper／Businessが2027年1月に終了予定で、24時間対応のBusiness Support+へ移行中です。ただし『24時間＝Business以上／専任TAM＝Enterprise』という考え方は変わりません。" },
    ],
...
const CHALLENGE = {
  ...
  // 追加（残り22レッスン）
  "l-cc-01": ["qm-cc01-1", "qm-cc01-2", "qm-cc01-3"],
  "l-cc-03": ["qm-cc03b-1", "qm-cc03b-2", "qm-cc03b-3"],
  "l-cc-04": ["qm-cc04b-1", "qm-cc04b-2", "qm-cc04b-3"],
  "l-cc-07": ["qm-cc07b-1", "qm-cc07b-2", "qm-cc07b-3"],
  "l-cc-08": ["qm-cc08b-1", "qm-cc08b-2", "qm-cc08b-3"],
  "l-sec-02": ["qm-sec02b-1", "qm-sec02b-2", "qm-sec02b-3"],
  "l-sec-04": ["qm-sec04b-1", "qm-sec04b-2", "qm-sec04b-3"],
  "l-sec-05": ["qm-sec05b-1", "qm-sec05b-2", "qm-sec05b-3"],
  "l-sec-07": ["qm-sec07b-1", "qm-sec07b-2", "qm-sec07b-3"],
  "l-sec-09": ["qm-sec09b-1", "qm-sec09b-2", "qm-sec09b-3"],
  "l-sec-10": ["qm-sec10b-1", "qm-sec10b-2", "qm-sec10b-3"],
  "l-tec-01": ["qm-tec01b-1", "qm-tec01b-2", "qm-tec01b-3"],
  "l-tec-04": ["qm-tec04b-1", "qm-tec04b-2", "qm-tec04b-3"],
  "l-tec-07": ["qm-tec07b-1", "qm-tec07b-2", "qm-tec07b-3"],
  "l-tec-10": ["qm-tec10b-1", "qm-tec10b-2", "qm-tec10b-3"],
  "l-tec-11": ["qm-tec11b-1", "qm-tec11b-2", "qm-tec11b-3"],
  "l-tec-12": ["qm-tec12b-1", "qm-tec12b-2", "qm-tec12b-3"],
  "l-tec-13": ["qm-tec13b-1", "qm-tec13b-2", "qm-tec13b-3"],
  "l-tec-14": ["qm-tec14b-1", "qm-tec14b-2", "qm-tec14b-3"],
  "l-bil-03": ["qm-bil03b-1", "qm-bil03b-2", "qm-bil03b-3"],
  "l-bil-04": ["qm-bil04b-1", "qm-bil04b-2", "qm-bil04b-3"],
  "l-bil-05": ["qm-bil05b-1", "qm-bil05b-2", "qm-bil05b-3"],
};
